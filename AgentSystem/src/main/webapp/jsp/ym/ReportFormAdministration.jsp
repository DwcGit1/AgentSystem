...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/jquery.table2excel.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/administration.js"></script>
