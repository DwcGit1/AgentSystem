...
<ul class="layui-nav" lay-filter="" style="width: 100%">
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child"> <!-- 二级菜单 -->
            <dd><a href="#" value="${pageContext.request.contextPath}/jsp/AgentManager/CheckByDateAccountDetails.jsp" onclick="load(this)">关键词申请</a></dd>
    ...
    <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child"> <!-- 二级菜单 -->
            ...
            <dd><a href="#" value="${pageContext.request.contextPath}/user/userShow" onclick="load(this)" id="load">用户管理</a></dd>
    ...
    <iframe id="key_iframe" src="${pageContext.request.contextPath}/user/userShow" onclick="load(this)" scrolling="no" width="100%" height="100%"></iframe>
