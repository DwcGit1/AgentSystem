    ...
    <script>
        function updateConfig(){
            ...
            if (confirm(msg)==true){
                ...
                window.location.href="${pageContext.request.contextPath}/yearservice/updateYear/?configValue="+configValue;
                //你也可以在这里做其他的操作
            }else{
                return false;
            }
...
<table class="layui-table" style="width: 1300px;text-align: center">
   ...
   <%-- <thead>
    ...
    <tr align="center" style="text-align: center;line-height: 50px">
        <th align="center" style="text-align: center"><h2>服务年限管理-填写最大的服务年限</h2></th>
    </tr>
    <tr align="center" style="text-align: center;line-height: 50px">
        <th align="center" style="text-align: center;line-height: 50px">
        <c:forEach items="${yearConfig}" var="yearConfigInfo" varStatus="status">
            配置名称:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" value="${yearConfigInfo.configTypeName}" readonly="true" style="height: 30px;text-align: center" >
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            配置数值:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text"  id="configValue" value="${yearConfigInfo.configValue}" style="height: 30px;text-align: center"><br>
            <button type="button" class="layui-btn layui-btn-sm" onclick="updateConfig()" style="width:60px;text-align: center">保存</button>
        </c:forEach>
        </th>
    </tr>
