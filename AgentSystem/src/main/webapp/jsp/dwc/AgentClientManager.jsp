...
<head>
    ...
    <link href="${pageContext.request.contextPath}/statics/layui-v2.5.5/layui/css/layui.css" rel="stylesheet">
...
<script>
    ...
    function add(){
        location.href="${pageContext.request.contextPath}/jsp/dwc/AddAccountDetail.jsp";
    }
    ...
    function lookclient(clientdata,th) {
        ...
        location.href="${pageContext.request.contextPath}/jsp/dwc/LookClients.jsp";
    }
    ...
    function  updateclient(clientdata,th) {
        ...
        communal(clientdata,th)
        location.href="${pageContext.request.contextPath}/jsp/dwc/UpdClientInfo.jsp";
    }
    //模糊查询
    function getclientByObj() {
        var obj=$('#customName').val();
        $.ajax({
            url : '${pageContext.request.contextPath}/sys/lookCustomlist.json',
            type : 'post',
            data : {'customName':obj},
            dataType : 'json',
    ...
    function switchoverstatus(th){
        ...
        layer.confirm('你确定'+text+'该用户吗', {
            ...
            item.push(i);
            $.ajax({
                url : '${pageContext.request.contextPath}/sys/updCustomStatus.json/'+item,
                type : 'post',
                data : null,
                dataType : 'json',
                success : function(result) {
    ...
    $(function () {
        $.ajax({
            url : '${pageContext.request.contextPath}/sys/showCustomlist.json',
            type : 'post',
            data : null,
            dataType : 'json',
            success : function(result) {
        ...
        $.ajax({
            url : '${pageContext.request.contextPath}/sys/get_contact.json',
            type : 'post',
            data : null,
            dataType : 'json',
            success : function(result) {
